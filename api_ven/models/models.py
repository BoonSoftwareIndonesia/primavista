            ...
            "order":[
                {
                    ...
                    "customerCode":"" if record['partner_shipping_id']['x_studio_customer_code'] == False else record['partner_shipping_id']['x_studio_customer_code'],
                    "soHeaderOptChar3":"",
...
#                     "shipNo": "" if record['x_studio_internal_id'] == False else record['x_studio_internal_id'],
                    "shipNo": "" if record['x_studio_customer_code'] == False else record['x_studio_internal_id'],
