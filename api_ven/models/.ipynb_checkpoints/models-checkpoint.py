...
#                     "shipNo": "" if record['x_studio_internal_id'] == False else record['x_studio_internal_id'],
                    ...
                    "shipAddress1":"" if record['partner_id']["street"] == False else record['partner_id']["street"],
                    "shipCity":"" if record['partner_id']["city"] == False else record['partner_id']["city"],
                    "shipZipCode":"" if record['partner_id']["zip"] == False else record['partner_id']["zip"],
                    "shipCountry":"" if record['partner_id']["country_id"]["name"] == False else record['partner_id']["country_id"]["name"],
